...
* [Voir le projet de création de notices UNIMARC à partir du dépôt des thèses d'exercice dans DUMAS ou OSKAR](theses2win.md)
* [See Python-WinIBW documentation to use Python in WinIBW's standart scripts](python-winibw.md)

...
* refonte de `addUA400` et `decompUA200enUA400` et ajout de `findUA200aUA200b` :
  ...
  * attention toutefois, ce couple de scripts requièrent toujours la présence d'un $a et d'un $b pour pouvoir fonctionner [(voir les modifications prévues)](./modifications.md#modifications-prevues).
